...
Feature: Telvero home page functionality
  ...
  Scenario: A user can navigate to learn why to use Telvero
    Given the user navigates to the navbar 'Why Telvero' button and an underline appears below it
  ...
  Scenario: A user can navigate to learn how Telvero works
    Given the user navigates to the navbar 'How it Works' button and an underline appears below it
  ...
  Scenario: A user can navigate to learn more about the features of Telvero
    Given the user navigates to the navbar 'Features' button and an underline appears below it
  ...
  # Color changes also work for the following registration page scenarios.
  @positive @register @navbar
  Scenario: A user can navigate to register as a new customer
    Given the user navigates to the navbar 'Try It For Free' button and the background color changes
  ...
  Scenario: A user can navigate in page to register as a new customer
    Given the user navigates to the 'Try It For Free' button and the background color changes
